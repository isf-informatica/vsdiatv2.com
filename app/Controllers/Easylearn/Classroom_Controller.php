...
class Classroom_Controller extends ResourceController
{
    ...
    public function Add_Student()
    {
        ...
        if(($SingleStudentData['student_add_token'] == $this->session->get('student_add_token')) && ($this->session->get('student_add_token') != NULL))
        {
            ...
            {
                $data = $this->Classroom_Model->Add_Single_Student($SingleStudentData, '', $this->session->get('user')['reg_id'], $this->session->get('user')['id']);
            }
            elseif ($permissions == 'Classroom') 
            {
                $data = $this->Classroom_Model->Add_Single_Student_Classroom($SingleStudentData, '', $this->session->get('user')['reg_id'], $this->session->get('user')['id'], $this->session->get('classroom_id'));
            }
