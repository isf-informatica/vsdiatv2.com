		...
		<div class="col-lg-10 col-12 offset-lg-1">
			<div class="box">
				<div class="box-header with-border text-center">
				  	<h4 class="box-title">Assign Courses To Classroom</h4>
				</div>
				<!-- /.box-header -->
                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <div class='col-md-10 m-15 align-self-center'>
                        <div class="table-responsive p-5">
                            <table id="assignclassroomcourse_list" class="table" style="width:100%">
                ...
                <div class="row d-flex justify-content-center mb-10">
                    <div class="col-lg-10 col-md-12">
                        <div class='d-flex justify-content-center'>
                            <button class="btn btn-rounded btn-success save-assign-classroom-course"> <i class="ti-save-alt"> Save </i> </button>
                        </div>
                    </div>
                </div>
...
<div class="modal fade none-border add-category" id="view_assigncourselist" tabindex="-1" role="dialog"
    aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><strong>Assigned Classroom Courses</strong></h4>
            ...
            <div class="modal-body">
            	<div class="table-responsive p-3">
                    <table id="assignclassroom_courselist" class="table" style="width:100%">
                        <thead>
                            <tr>
                                <th>Sr. No.</th>
                                <th>Course Name</th>
