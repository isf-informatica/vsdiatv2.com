                                ...
                                <div class="col-md-12">
                                    <div class="box-body">
                                        <div class="table-responsive">
                                            <table id="first_jrclg_requests" class="table align-middle p-5" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th scope="col">College Medium</th>
                        ...
                        <div class="p-15">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="box-body">
                                        <div class="table-responsive ">
                                            <table id="final_jrclg_requests" class="table p-5" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        <th scope="col">Sr. No.</th>
                                                        <th scope="col">College Name</th>
...
<div class="modal fade show" id="view_jrclg_modal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="staticBackdropLabel" style="color:#3c6fd0;">Jr College Information: </h4>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-12 col-md-6 mt-3 align-self-center">
                        <div class="text-center">
                            <img src="" class="img jrclg_logo" style="height: 200px; width: 200px; border-radius:50%;" alt="">
                        </div>
                    </div>

                    <div class="col-12 col-md-6 mt-3 align-self-center">
                        <div class="text-center">
                            <img src="" class="img jrclg_image" style="height: 200px; width: 200px; border-radius:50%;" alt="">
                        </div>
                    </div>

                    <div class="col-12 col-md-12 align-self-center">
                        <div class="text-center m-3">
                            <h4><b class="jrclg_name"> College Name</b></h4>
                        </div>
                    </div>
                    ...
                    <div class="col-12 mt-3">
                        <div class='d-flex justify-content-center p-5'>
                            <button type="button" id="jrclg_disapprove" class="btn waves-effect waves-light btn-danger btn-md">Disapprove</button>&emsp;&emsp;
                            <button type="button" id="jrclg_approve" class="btn waves-effect waves-light btn-primary btn-md">Approve</button>
                        </div>
                    </div>
                </div>
            </div>
