            ...
            <div class="col-12">
                ...
                <div class="box">
                    <div class="box-body">
                        ...
                        <h4 class="text-center text-dark bold">MCQ Exam List</h4>
                            ...
                            <div class="row exam_list_holder">
                                <div class="col-md-12 d-none exam_list">
                                    <div class="border-top px-5 py-4 min-height-70 d-md-flex align-items-center">
                                        ...
                                        <div class="d-flex align-items-center overflow-visible flex-shrink-all">
                                            <div
                                            ...
                                            <a href="Ielts_reading_exams" target='_blank'
                                                ...
                                                style='font-size: 14px;' data-aos-duration="200" data-aos="fade-up"><b
                                                    style="font-size: 14px;"> Start
                                                    Test </b>
                                                <!-- Icon -->
