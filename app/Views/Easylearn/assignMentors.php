<?php 
	...
	$mentor = json_decode(get_mentor_status($_GET['id']), true)['data'];
?>
		...
		<div class="col-lg-10 col-12 offset-lg-1">
			<div class="box">
				<div class="box-header with-border text-center">
				    <h4 class="box-title">Assign Courses </h4>
				</div>

                <div class='row'>
                    <div class='col-6'>
                        <div class="text-start p-3">   
                            <a href="manageMentors" class="btn btn-info active" ><i class="fas fa-backward"></i>&nbsp;&nbsp;Back</a>
                        </div>
                    </div>
