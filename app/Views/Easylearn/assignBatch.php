		...
		<div class="col-lg-10 col-12 offset-lg-1">
			<div class="box">
				<div class="box-header with-border text-center">
				  	<h4 class="box-title">Assign Students To <?=$_GET['batch'];?> Batch</h4>
				</div>
				...
				<div class="tab-content mt-30">
                    <div class="tab-pane active" id="first-stage" role="tabpanel">
						<div class="row d-flex justify-content-center">
							...
							<div class='col-lg-10 m-20'>
								<span><b>Want to show Students From Another Batch ?</b></span>
								<button type="button" style='border-radius: 20px;' class="btn showotherbatch_member btn-md btn-toggle1"  data-toggle="button" aria-pressed="false" autocomplete="off">
							...
							<div class='col-md-10 m-15 align-self-center'>
								<div class="table-responsive p-5">
									<table id="assignbatch_list" class="table" style="width:100%">
						...
						<div class="row d-flex justify-content-center mb-10">
							<div class="col-lg-10 col-md-12">
								<div class='d-flex justify-content-center'>
									<button class="btn btn-rounded btn-success save-assign-batch"> <i class="ti-save-alt"> Save </i> </button>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="tab-pane" id="final-stage" role="tabpanel">
						...
						<div class="row justify-content-start">
							...
							<div class="col-md-11">
								<div class="form-label-group">
									...
									<a href="Download_Assign_Student_Template" class="btn btn-primary DownloadTemplate">
						...
						<div class="row justify-content-center">
							<div class="col-md-10 m-30">
								<span><b>Add Students From Another Batch ?</b></span>
								<button type="button" style='border-radius: 20px;' id='another_batch' class="btn btn-md btn-toggle1"  data-toggle="button" aria-pressed="false" autocomplete="off">
									<div style='border-radius: 50%;' class="handle"></div>
								</button>
							</div>
						</div>
						...
						<div class="row justify-content-center">
							<div class="col-md-10">
								<div class="form-label-group">
									...
									<input type="file" class="dropify" id="csv_assign_Student" data-height="200" accept=".csv" />
								</div>
							</div>
						</div>
						<br>
						...
						<div class="row justify-content-center pb-15">
							<div class="col-md-12 text-center">
								<div class="form-label-group">
									<button type="button" class="btn btn-primary" id="csv_assign_Student_submit">Assign Students</button>
								</div>
							</div>
						</div>
					</div>
...
<div class="modal fade none-border add-category" id="view_assignmemberlist" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><strong>Assign Batch Students</strong></h4>
            ...
            <div class="modal-body">
            	<div class="table-responsive p-3">
                    <table id="assignbatch_memberlist" class="table" style="width:100%">
                        <thead>
                            <tr>
                                <th>Sr. No.</th>
                                <th>Student Name</th>
