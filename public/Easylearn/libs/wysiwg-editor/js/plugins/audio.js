(function(FE, $, _) {
  ...
  $.extend(FE.DEFAULTS, {
    ...
    audioAllowedTypes1: ['audio/mp3', 'audio/mpeg', 'audio/x-m4a'],
    ...
    audioUploadParams: {},
    audioUploadURL: 'Easylearn/Exam_Controller/upload_editor_images'
  });
  ...
  FE.PLUGINS.audio = function(editor) {
    ...
    return {
      ...
      upload(audios) {
        ...
        if (!editor.opts.audioAllowedTypes1.includes(audio.type)) {
